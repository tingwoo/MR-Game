...
public class NetworkHalfRing : NetworkBehaviour
{
    ...
    public NetworkHalfRingCollider collider1;
    public NetworkHalfRingCollider collider2;
    ...
    void Update()
    {
        if (collider1.CollidedRing != null && collider2.CollidedRing != null &&
            collider1.CollidedRing.NetworkObjectId == collider2.CollidedRing.NetworkObjectId)
        {
            NetworkHalfRing other = collider1.CollidedRing;
            if (NetworkObjectId > other.NetworkObjectId)
            {
